...
const getTransactionId_1 = require("../../app/Utils/getTransactionId");
...
const createBooking = async (payload, userId) => {
    ...
    try {
        ...
        if (!user?.phone || !user?.address) {
            throw new AppError_1.default(http_status_codes_1.default.BAD_REQUEST, "Please Update your Phone and address to book tour");
        }
